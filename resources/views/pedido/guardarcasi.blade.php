...
<a href="/pedido/crearcas" class="btn btn-primary">Cerrar</a>
        &nbsp; &nbsp;
        
        <a href="/pedido/comercasi" class="btn btn-primary">Limpiar</a>
      &nbsp; &nbsp;
        <button type="submit" class="btn btn-primary" name="casi">Guardar y cerrar</button>
      </div>
